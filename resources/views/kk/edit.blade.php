                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no" id="no"
                                       placeholder="Contoh : 3215069871627772" readonly maxlength="16" value="{{$kk->no}}">
                            </div>
                            <div class="form-group">
                                <label for="kepala">Nama Kepala Keluarga</label>
                                <input type="text" class="form-control" id="KepalaKeluarga" name="KepalaKeluarga"
                                       placeholder="Contoh : Nathaniel Valentino Robert" autofocus maxlength="100" value="{{$kk->KepalaKeluarga}}">
                            </div>
                        </div>
